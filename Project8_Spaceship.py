...
class Sprite:
    ...
    def draw(self, canvas):
        ...
        if self.animated:
            newcenter = [explosion_info.get_center()[0] + self.age * explosion_info.get_size()[0], explosion_info.get_center()[1]]
            canvas.draw_image(explosion_image, newcenter, explosion_info.get_size(),
